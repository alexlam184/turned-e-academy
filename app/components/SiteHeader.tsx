          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="group relative">
              ...
              <div className="pointer-events-none invisible absolute left-0 top-full z-20 mt-3 w-64 rounded-2xl border border-orange-100 bg-white p-3 text-sm text-gray-700 opacity-0 shadow-xl transition group-hover:pointer-events-auto group-hover:visible group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:visible group-focus-within:opacity-100">
                <a
                  className="block rounded-xl px-3 py-2 hover:bg-orange-50"
        ...
        <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <div className="relative group">
              <button className="text-gray-700 hover:text-orange-500 transition-colors font-medium flex items-center space-x-1">
                <span>Programs</span>
              ...
              <div className="absolute left-0 mt-0 w-48 bg-white rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                {programsMenu.map((item, idx) => (
                  <a
                    ...
                    className="block px-4 py-3 text-gray-700 hover:text-orange-500 hover:bg-orange-50 transition-all first:rounded-t-xl last:rounded-b-xl"
                  >
                    {item.name}
                  </a>
                ))}
            ...
            <div className="container mx-auto px-4 py-4 space-y-3">
              ...
              <div>
                <button
                  ...
                  className="w-full text-left text-gray-700 hover:text-orange-500 transition-colors font-medium py-2 flex items-center justify-between"
                >
                  <span>Programs</span>
                  <ChevronDown
              ...
              <button className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-2 rounded-full font-semibold hover:scale-105 transform transition-all shadow-lg mt-4">
                Enroll Now
              </button>
            </div>
          </div>
